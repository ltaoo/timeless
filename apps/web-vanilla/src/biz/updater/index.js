...
export function createCheckUpdateButton($root, $output) {
  ...
  $btnCheckUpdate.onclick = function () {
    ...
    const url =
      "funzm://localhost/rpc?method=CheckUpdate&args=" +
...
export function showUpdateAvailable(data, $root, $output) {
  ...
  $downloadBtn.onclick = function () {
    ...
    const url =
      "funzm://localhost/rpc?method=DownloadUpdate&args=" +
      encodeURIComponent(JSON.stringify({ version: data.version }));
      ...
      .then(function (result) {
        if (result.success) {
          ...
          $restartBtn.onclick = function () {
            ...
            function fetchLogs() {
              const logsUrl =
                "funzm://localhost/rpc?method=GetUpdateLogs&args=" +
                encodeURIComponent(JSON.stringify({}));
            ...
            const restartUrl =
              "funzm://localhost/rpc?method=RestartApp&args=" +
              encodeURIComponent(JSON.stringify({}));
            ...
            setTimeout(function () {
              ...
              if (document.visibilityState === "visible") {
                ...
                const diagUrl =
                  "funzm://localhost/rpc?method=RestartDiagnostics&args=" +
                  encodeURIComponent(JSON.stringify({}));
                fetch(diagUrl)
                  .then(function (resp) {
                    return resp.json();
  ...
  $remindBtn.onclick = function () {
    ...
    const url =
      "funzm://localhost/rpc?method=RemindLater&args=" +
      encodeURIComponent(JSON.stringify({}));
  ...
  $skipBtn.onclick = function () {
    ...
    const url =
      "funzm://localhost/rpc?method=SkipVersion&args=" +
      encodeURIComponent(JSON.stringify({ version: data.version }));
