declare namespace Timeless {
  ...
  type UnpackedResult<T> = NonNullable<
  ...
  declare type WildcardHandler<T = Record<string, unknown>> = (
    type: keyof T,
    event: T[keyof T],
  ) => void;
  declare type EventHandlerList<T = unknown> = Array<Handler<T>>;
  declare type WildCardEventHandlerList<T = Record<string, unknown>> = Array<
    WildcardHandler<T>
  >;
  ...
  declare class StorageCore<
    T extends Record<string, unknown>,
  > extends BaseDomain<TheTypesOfEvents$C<T>> {
    key: string;
    values: T;
    defaultValues: T;
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$C<T>[Events$y.StateChange]>,
    ): () => void;
  }
  ...
  declare class ApplicationModel<
    T extends {
      storage: StorageCore<any>;
    },
  > extends BaseDomain<TheTypesOfEvents$B> {
    ...
    getTheme(): string;
    tipUpdate(): void;
    tip(arg: { icon?: unknown; text: string[] }): string;
    ...
    enablePointer(): void;
    /** 平台相关的全局事件 */
    keydown(event: { code: string; preventDefault: () => void }): void;
    escape(): void;
    ...
    onDeviceSizeChange(
      handler: Handler<TheTypesOfEvents$B[Events$x.DeviceSizeChange]>,
    ): () => void;
    onUpdate(
      handler: Handler<TheTypesOfEvents$B[Events$x.ForceUpdate]>,
    ): () => void;
    /** 平台相关全局事件 */
    onOrientationChange(
      handler: Handler<TheTypesOfEvents$B[Events$x.OrientationChange]>,
    ): () => void;
    ...
    onKeydown(
      handler: Handler<TheTypesOfEvents$B[Events$x.Keydown]>,
    ): () => void;
    onEscapeKeyDown(
      handler: Handler<TheTypesOfEvents$B[Events$x.EscapeKeyDown]>,
    ): () => void;
    onTip(handler: Handler<TheTypesOfEvents$B[Events$x.Tip]>): () => void;
    onLoading(
      handler: Handler<TheTypesOfEvents$B[Events$x.Loading]>,
    ): () => void;
    onHideLoading(
      handler: Handler<TheTypesOfEvents$B[Events$x.HideLoading]>,
    ): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$B[Events$x.StateChange]>,
    ): () => void;
    /**
     * ----------------
     * Event
  ...
  declare class PresenceCore extends BaseDomain<TheTypesOfEvents$A> {
    ...
    reset(): void;
    onTmpShow(
      handler: Handler<TheTypesOfEvents$A[Events$w.TmpShow]>,
    ): () => void;
    onTmpHidden(
      handler: Handler<TheTypesOfEvents$A[Events$w.TmpHidden]>,
    ): () => void;
    ...
    onUnmounted(
      handler: Handler<TheTypesOfEvents$A[Events$w.Unmounted]>,
    ): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$A[Events$w.StateChange]>,
    ): () => void;
    onPresentChange(
      handler: Handler<TheTypesOfEvents$A[Events$w.PresentChange]>,
    ): () => void;
    get [Symbol.toStringTag](): string;
  }
  ...
  declare class RouteViewCore extends BaseDomain<TheTypesOfEvents$z> {
    ...
    onMounted(
      handler: Handler<TheTypesOfEvents$z[Events$v.Mounted]>,
    ): () => void;
    onViewShow(
      handler: Handler<TheTypesOfEvents$z[Events$v.ViewShow]>,
    ): () => void;
    onBeforeShow(
      handler: Handler<TheTypesOfEvents$z[Events$v.BeforeShow]>,
    ): () => void;
    onShow(handler: Handler<TheTypesOfEvents$z[Events$v.Show]>): () => void;
    onBeforeHide(
      handler: Handler<TheTypesOfEvents$z[Events$v.BeforeHide]>,
    ): () => void;
    onHidden(handler: Handler<TheTypesOfEvents$z[Events$v.Hidden]>): () => void;
    onLayered(
      handler: Handler<TheTypesOfEvents$z[Events$v.Layered]>,
    ): () => void;
    onUncover(
      handler: Handler<TheTypesOfEvents$z[Events$v.Uncover]>,
    ): () => void;
    onUnmounted(
      handler: Handler<TheTypesOfEvents$z[Events$v.Unmounted]>,
    ): () => void;
    onSubViewChanged(
      handler: Handler<TheTypesOfEvents$z[Events$v.SubViewChanged]>,
    ): () => void;
    onSubViewAppended(
      handler: Handler<TheTypesOfEvents$z[Events$v.SubViewAppended]>,
    ): () => void;
    onSubViewRemoved(
      handler: Handler<TheTypesOfEvents$z[Events$v.SubViewRemoved]>,
    ): () => void;
    onSubViewsChange(
      handler: Handler<TheTypesOfEvents$z[Events$v.SubViewsChange]>,
    ): () => void;
    onCurViewChange(
      handler: Handler<TheTypesOfEvents$z[Events$v.CurSubViewChange]>,
    ): () => void;
    onMatched(handler: Handler<TheTypesOfEvents$z[Events$v.Match]>): () => void;
    onNotFound(
      handler: Handler<TheTypesOfEvents$z[Events$v.NotFound]>,
    ): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$z[Events$v.StateChange]>,
    ): () => void;
  }
  declare function onViewCreated(fn: (views: RouteViewCore) => void): void;
  declare function RouteMenusModel<
    T extends {
      title: string;
      url?: unknown;
      onClick?: (m: T) => void;
  ...
  >(props: {
    ...
    state: {
      readonly menus: T[];
      readonly cur: RouteViewCore | null;
    };
    readonly menus: T[];
    readonly cur: RouteViewCore | null;
  ...
  declare class NavigatorCore extends BaseDomain<TheTypesOfEvents$y> {
    ...
    onHistoryChange(
      handler: Handler<TheTypesOfEvents$y[Events$u.HistoriesChange]>,
    ): () => void;
    onPushState(
      handler: Handler<TheTypesOfEvents$y[Events$u.PushState]>,
    ): () => void;
    onReplaceState(
      handler: Handler<TheTypesOfEvents$y[Events$u.ReplaceState]>,
    ): () => void;
    onPopState(
      handler: Handler<TheTypesOfEvents$y[Events$u.PopState]>,
    ): () => void;
    onReload(handler: Handler<TheTypesOfEvents$y[Events$u.Reload]>): () => void;
    onPathnameChange(
      handler: Handler<TheTypesOfEvents$y[Events$u.PathnameChange]>,
    ): () => void;
    onBack(handler: Handler<TheTypesOfEvents$y[Events$u.Back]>): () => void;
    onForward(
      handler: Handler<TheTypesOfEvents$y[Events$u.Forward]>,
    ): () => void;
    onRelaunch(
      handler: Handler<TheTypesOfEvents$y[Events$u.Relaunch]>,
    ): () => void;
    onHistoriesChange(
      handler: Handler<TheTypesOfEvents$y[Events$u.HistoriesChange]>,
    ): () => void;
  ...
  > extends BaseDomain<TheTypesOfEvents$x> {
    virtual: boolean;
    /** 路由配置 */
    routes: Record<K, R>;
    /** 加载的所有视图 */
    ...
    onTopViewChange(
      handler: Handler<TheTypesOfEvents$x[Events$t.TopViewChange]>,
    ): () => void;
    onRouteChange(
      handler: Handler<TheTypesOfEvents$x[Events$t.RouteChange]>,
    ): () => void;
    onBack(handler: Handler<TheTypesOfEvents$x[Events$t.Back]>): () => void;
    onForward(
      handler: Handler<TheTypesOfEvents$x[Events$t.Forward]>,
    ): () => void;
    onClickLink(
      handler: Handler<TheTypesOfEvents$x[Events$t.ClickLink]>,
    ): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$x[Events$t.StateChange]>,
    ): () => void;
  }
  ...
  declare class HttpClientCore extends BaseDomain<TheTypesOfEvents$w> {
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$w[Events$s.StateChange]>,
    ): () => void;
  }
  ...
  declare class RefCore<T> extends BaseDomain<TheTypesOfEvents$v<T>> {
    ...
    clear(): void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$v<T>[Events$r.StateChange]>,
    ): () => void;
  }
  ...
  declare class ButtonCore<T = unknown> extends BaseDomain<
    TheTypesOfEvents$u<T>
  > {
    id: number;
    cur: RefCore<T>;
    state: ButtonState;
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$u<T>[Events$q.StateChange]>,
    ): void;
  }
  ...
  declare class ButtonInListCore<T> extends BaseDomain<
    TheTypesInListOfEvents$2<T>
  > {
    /** 列表中一类多个按钮 */
    btns: ButtonCore<T>[];
    ...
    click(): void;
    onClick(
      handler: Handler<TheTypesInListOfEvents$2<T>[Events$q.Click]>,
    ): void;
    onStateChange(
      handler: Handler<TheTypesInListOfEvents$2<T>[Events$q.StateChange]>,
    ): void;
  }
  ...
  declare class CheckboxCore extends BaseDomain<TheTypesOfEvents$t> {
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$t[Events$p.StateChange]>,
    ): () => void;
  }
  ...
  declare class PopperCore extends BaseDomain<TheTypesOfEvents$s> {
    ...
    /** 更新基准元素（右键菜单时会用到这个方法） */
    updateReference(reference: { getRect: () => Rect }): void;
    ...
    reset(): void;
    onReferenceMounted(
      handler: Handler<TheTypesOfEvents$s[Events$o.ReferenceMounted]>,
    ): () => void;
    onFloatingMounted(
      handler: Handler<TheTypesOfEvents$s[Events$o.FloatingMounted]>,
    ): () => void;
    onContainerChange(
      handler: Handler<TheTypesOfEvents$s[Events$o.ContainerChange]>,
    ): () => void;
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$s[Events$o.StateChange]>,
    ): () => void;
    get [Symbol.toStringTag](): string;
  }
  ...
  declare class DismissableLayerCore extends BaseDomain<TheTypesOfEvents$r> {
    ...
    onDismiss(
      handler: Handler<TheTypesOfEvents$r[Events$n.Dismiss]>,
    ): () => void;
  }
  ...
  declare class MenuItemCore extends BaseDomain<TheTypesOfEvents$q> {
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$q[Events$m.Change]>,
    ): () => void;
    get [Symbol.toStringTag](): string;
  }
  ...
  declare class MenuCore extends BaseDomain<TheTypesOfEvents$p> {
    ...
    onEnterItem(
      handler: Handler<TheTypesOfEvents$p[Events$l.EnterItem]>,
    ): () => void;
    onLeaveItem(
      handler: Handler<TheTypesOfEvents$p[Events$l.LeaveItem]>,
    ): () => void;
    onEnter(
      handler: Handler<TheTypesOfEvents$p[Events$l.EnterMenu]>,
    ): () => void;
    onLeave(
      handler: Handler<TheTypesOfEvents$p[Events$l.LeaveMenu]>,
    ): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$p[Events$l.StateChange]>,
    ): () => void;
    get [Symbol.toStringTag](): string;
  }
  ...
  declare class ContextMenuCore extends BaseDomain<TheTypeOfEvent> {
    ...
    hide(): void;
    setReference(reference: { getRect: () => Rect }): void;
    updateReference(reference: { getRect: () => Rect }): void;
    setItems(items: MenuItemCore[]): void;
  ...
  declare class DialogCore extends BaseDomain<TheTypesOfEvents$o> {
    ...
    onUnmounted(
      handler: Handler<TheTypesOfEvents$o[Events$j.Unmounted]>,
    ): () => void;
    onVisibleChange(
      handler: Handler<TheTypesOfEvents$o[Events$j.VisibleChange]>,
    ): () => void;
    onOk(handler: Handler<TheTypesOfEvents$o[Events$j.OK]>): () => void;
    onCancel(handler: Handler<TheTypesOfEvents$o[Events$j.Cancel]>): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$o[Events$j.StateChange]>,
    ): () => void;
    get [Symbol.toStringTag](): string;
  }
  ...
  declare class DropdownMenuCore extends BaseDomain<TheTypesOfEvents$n> {
    ...
    unmount(): void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$n[Events$i.StateChange]>,
    ): void;
  }
  ...
  declare class FocusScopeCore extends BaseDomain<TheTypesOfEvents$m> {
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$m[Events$h.StateChange]>,
    ): void;
  }
  ...
  > extends BaseDomain<TheTypesOfEvents$l> {
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$l[Events$g.StateChange]>,
    ): () => void;
  }
  ...
  declare class SingleFieldCore<T extends FormInputInterface<any>> {
    ...
    _dirty: boolean;
    _bus: {
      off<Key extends BaseEvents.Destroy | keyof TheSingleFieldCoreEvents<T>>(
        event: Key,
        handler: Handler<
          ({
            __destroy: void;
      ...
      on<Key extends BaseEvents.Destroy | keyof TheSingleFieldCoreEvents<T>>(
        event: Key,
        handler: Handler<
          ({
            __destroy: void;
      ...
      uid: () => number;
      emit<Key extends BaseEvents.Destroy | keyof TheSingleFieldCoreEvents<T>>(
        event: Key,
        value?: ({
          __destroy: void;
        } & TheSingleFieldCoreEvents<T>)[Key],
  ...
  > {
    ...
    _field: T;
    _bus: {
      off<Key extends BaseEvents.Destroy | keyof TheArrayFieldCoreEvents<T>>(
        event: Key,
        handler: Handler<
          ({
            __destroy: void;
      ...
      on<Key extends BaseEvents.Destroy | keyof TheArrayFieldCoreEvents<T>>(
        event: Key,
        handler: Handler<
          ({
            __destroy: void;
      ...
      uid: () => number;
      emit<Key extends BaseEvents.Destroy | keyof TheArrayFieldCoreEvents<T>>(
        event: Key,
        value?: ({
          __destroy: void;
        } & TheArrayFieldCoreEvents<T>)[Key],
  ...
  > {
    ...
    rules: FieldRuleCore[];
    _bus: {
      off<Key extends BaseEvents.Destroy | keyof TheObjectFieldCoreEvents<T>>(
        event: Key,
        handler: Handler<
          ({
            __destroy: void;
      ...
      on<Key extends BaseEvents.Destroy | keyof TheObjectFieldCoreEvents<T>>(
        event: Key,
        handler: Handler<
          ({
            __destroy: void;
      ...
      uid: () => number;
      emit<Key extends BaseEvents.Destroy | keyof TheObjectFieldCoreEvents<T>>(
        event: Key,
        value?: ({
          __destroy: void;
        } & TheObjectFieldCoreEvents<T>)[Key],
  ...
  declare class ImageCore extends BaseDomain<TheTypesOfEvents$k> {
    ...
    handleError(): void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$k[Events$f.StateChange]>,
    ): () => void;
    onStartLoad(
      handler: Handler<TheTypesOfEvents$k[Events$f.StartLoad]>,
    ): () => void;
  ...
  declare class InputCore<T>
    extends BaseDomain<TheTypesOfEvents$j<T>>
    implements ValueInputInterface<T>
  {
    ...
    enter(): void;
    onChange(
      handler: Handler<TheTypesOfEvents$j<T>[Events$e.Change]>,
    ): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$j<T>[Events$e.StateChange]>,
    ): () => void;
    onMounted(
      handler: Handler<TheTypesOfEvents$j<T>[Events$e.Mounted]>,
    ): () => void;
    onFocus(
      handler: Handler<TheTypesOfEvents$j<T>[Events$e.Focus]>,
    ): () => void;
    onBlur(handler: Handler<TheTypesOfEvents$j<T>[Events$e.Blur]>): () => void;
    onKeyDown(
      handler: Handler<TheTypesOfEvents$j<T>[Events$e.KeyDown]>,
    ): () => void;
    onEnter(
      handler: Handler<TheTypesOfEvents$j<T>[Events$e.Enter]>,
    ): () => void;
    onClick(
      handler: Handler<TheTypesOfEvents$j<T>[Events$e.Click]>,
    ): () => void;
    onClear(
      handler: Handler<TheTypesOfEvents$j<T>[Events$e.Clear]>,
    ): () => void;
  }
  ...
  declare class InputInListCore<K extends string, T> extends BaseDomain<
    TheTypesInListOfEvents$1<K, T>
  > {
    defaultValue: T;
    list: InputCore<T>[];
    ...
    /** 清空触发点击事件时保存的按钮 */
    onChange(
      handler: Handler<TheTypesInListOfEvents$1<K, T>[Events$e.Change]>,
    ): void;
    onStateChange(
      handler: Handler<TheTypesInListOfEvents$1<K, T>[Events$e.StateChange]>,
    ): void;
  }
  ...
  declare class NodeCore extends BaseDomain<TheTypesOfEvents$i> {
    handleShow(): void;
    onVisible(
      handler: Handler<TheTypesOfEvents$i[Events$d.EnterViewport]>,
    ): () => void;
  ...
  declare class PopoverCore extends BaseDomain<TheTypesOfEvents$h> {
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$h[Events$c.StateChange]>,
    ): () => void;
    get [Symbol.toStringTag](): string;
  }
  ...
  declare class ProgressCore extends BaseDomain<TheTypesOfEvents$g> {
    ...
    onValueChange(
      handler: Handler<TheTypesOfEvents$g[Events$b.ValueChange]>,
    ): void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$g[Events$b.StateChange]>,
    ): void;
  }
  ...
  declare class RovingFocusCore extends BaseDomain<TheTypesOfEvents$e> {
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$e[Events$a.StateChange]>,
    ): void;
    onItemFocus(handler: Handler<TheTypesOfEvents$e[Events$a.ItemFocus]>): void;
    onItemShiftTab(
      handler: Handler<TheTypesOfEvents$e[Events$a.ItemShiftTab]>,
    ): void;
    onFocusableItemAdd(
      handler: Handler<TheTypesOfEvents$e[Events$a.FocusableItemAdd]>,
    ): void;
    onFocusableItemRemove(
      handler: Handler<TheTypesOfEvents$e[Events$a.FocusableItemRemove]>,
    ): void;
  }
  ...
  declare function getAngleByPoints(
    lastPoint: {
      x: number;
      y: number;
    },
  ...
  declare class ScrollViewCore extends BaseDomain<TheTypesOfEvents$d> {
    ...
    destroy: () => void;
    inDownOffset(
      handler: Handler<TheTypesOfEvents$d[Events$9.InDownOffset]>,
    ): () => void;
    outDownOffset(
      handler: Handler<TheTypesOfEvents$d[Events$9.OutDownOffset]>,
    ): () => void;
    onPulling(
      handler: Handler<TheTypesOfEvents$d[Events$9.Pulling]>,
    ): () => void;
    onScroll(
      handler: Handler<TheTypesOfEvents$d[Events$9.Scrolling]>,
    ): () => void;
    onReachBottom(
      handler: Handler<TheTypesOfEvents$d[Events$9.ReachBottom]>,
    ): () => void;
    onPullToRefresh(
      handler: Handler<TheTypesOfEvents$d[Events$9.PullToRefresh]>,
    ): () => void;
    onMounted(
      handler: Handler<TheTypesOfEvents$d[Events$9.Mounted]>,
    ): () => void;
  }
  ...
  declare class SelectItemCore<T> extends BaseDomain<TheTypesOfEvents$8<T>> {
    ...
    enter(): void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$8<T>[Events$8.StateChange]>,
    ): () => void;
    onLeave(
      handler: Handler<TheTypesOfEvents$8<T>[Events$8.Leave]>,
    ): () => void;
    onEnter(
      handler: Handler<TheTypesOfEvents$8<T>[Events$8.Enter]>,
    ): () => void;
    onFocus(
      handler: Handler<TheTypesOfEvents$8<T>[Events$8.Focus]>,
    ): () => void;
  ...
  declare class SelectCore<T> extends BaseDomain<TheTypesOfEvents$7<T>> {
    ...
    setTriggerPointerDownPos(pos: { x: number; y: number }): void;
    ...
    setPosition(): void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$7<T>[Events$7.StateChange]>,
    ): () => void;
    onValueChange(
      handler: Handler<TheTypesOfEvents$7<T>[Events$7.Change]>,
    ): () => void;
    onChange(
      handler: Handler<TheTypesOfEvents$7<T>[Events$7.Change]>,
    ): () => void;
    onFocus(
      handler: Handler<TheTypesOfEvents$7<T>[Events$7.Focus]>,
    ): () => void;
  }
  ...
  declare class SelectInListCore<K extends string, T> extends BaseDomain<
  ...
  > {
    ...
    /** 清空触发点击事件时保存的按钮 */
    onChange(
      handler: Handler<TheTypesInListOfEvents<K, T>[Events$7.Change]>,
    ): void;
    onStateChange(
      handler: Handler<TheTypesInListOfEvents<K, T>[Events$7.StateChange]>,
    ): void;
  }
  ...
  declare class TabsCore extends BaseDomain<TheTypesOfEvents$6> {
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$6[Events$6.StateChange]>,
    ): void;
    onValueChange(
      handler: Handler<TheTypesOfEvents$6[Events$6.ValueChange]>,
    ): void;
  }
  ...
  declare class ToastCore extends BaseDomain<TheTypesOfEvents$5> {
    ...
    onOpenChange(
      handler: Handler<TheTypesOfEvents$5[Events$5.OpenChange]>,
    ): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$5[Events$5.StateChange]>,
    ): () => void;
    get [Symbol.toStringTag](): string;
  }
   ...
   */
  declare const formatSourceNodes: (
   ...
   */
  declare function calcDropPosition(
    e: any,
    treeNode: any,
   ...
   */
  declare const findSourceNodeByKey: (
    sourceNodes: SourceNode[],
    key: string,
   ...
   */
  declare function computeMoveNeededParams(
    sourceNodes: SourceNode[],
   ...
   * @param {Array<SourceNode>} originSourceNodes
   */
  declare function insertToBottom(
    targetSourceNodeIndex: number,
    targetSourceNodes: SourceNode[],
    originSourceNode: SourceNode,
    originSourceNodeIndex: number,
  ...
  declare class TreeCore extends BaseDomain<TheTypesOfEvents$4> {
    onStateChange(
      handler: Handler<TheTypesOfEvents$4[Events$4.StateChange]>,
    ): () => void;
  }
  ...
  declare class CheckboxGroupCore<T extends any> extends BaseDomain<
    TheTypesOfEvents$3<T>
  > {
    ...
    onChange(
      handler: Handler<TheTypesOfEvents$3<T>[Events$3.Change]>,
    ): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents$3<T>[Events$3.StateChange]>,
    ): () => void;
  }
   ...
   * //=> Tue Feb 11 2014 11:30:30
   */
  declare function toDate<DateType extends Date = Date>(
   ...
   * }
   */
  declare function constructFrom<DateType extends Date>(
   ...
   */
  declare function startOfMonth<DateType extends Date>(
    date: DateType | number,
  ): DateType;
  /**
   ...
   * //=> 8
   */
  declare function differenceInCalendarMonths<DateType extends Date>(
  ...
  declare function daysToMonthWeeks(
    fromDate: Date,
    toDate: Date,
    options?: {
      ISOWeek?: boolean;
   ...
   * //=> 53
   */
  declare function getWeek<DateType extends Date>(
    date: DateType | number,
   ...
   */
  declare function startOfWeekYear<DateType extends Date>(
    date: DateType | number,
   ...
   * //=> 2004
   */
  declare function getWeekYear<DateType extends Date>(
    date: DateType | number,
   ...
   * //=> Mon Sep 01 2014 00:00:00
   */
  declare function startOfISOWeek<DateType extends Date>(
    date: DateType | number,
  ): DateType;
  /**
   * @name getISOWeek
   ...
   * //=> 53
   */
  declare function getISOWeek<DateType extends Date>(
    date: DateType | number,
  ): number;
  /**
   ...
   * //=> Mon Jan 03 2005 00:00:00
   */
  declare function startOfISOWeekYear<DateType extends Date>(
    date: DateType | number,
  ): DateType;
  /**
   * @name getISOWeekYear
   ...
   * //=> 2004
   */
  declare function getISOWeekYear<DateType extends Date>(
    date: DateType | number,
  ): number;
  /**
   * @name endOfISOWeek
   ...
   */
  declare function endOfISOWeek<DateType extends Date>(
    date: DateType | number,
  ): DateType;
  /**
   ...
   * //=> Sun Sep 07 2014 23:59:59.999
   */
  declare function endOfWeek<DateType extends Date>(
    date: DateType | number,
   ...
   */
  declare function getMonthWeeks(
    month: Date,
    options: {
      locale: Locale;
  ...
  interface GetWeeksInMonthOptions
    extends LocalizedOptions<"options">, WeekOptions {}
  /**
   ...
   * //=> 6
   */
  declare function getWeeksInMonth<DateType extends Date>(
    date: DateType | number,
   ...
   * //=> 2
   */
  declare function differenceInCalendarWeeks<DateType extends Date>(
    dateLeft: DateType | number,
    dateRight: DateType | number,
   ...
   * //=> Mon Sep 01 2014 00:00:00
   */
  declare function startOfWeek<DateType extends Date>(
    date: DateType | number,
   ...
   */
  declare function lastDayOfMonth<DateType extends Date>(
    date: DateType | number,
  ): DateType;
  /**
   * @name addWeeks
   ...
   */
  declare function addWeeks<DateType extends Date>(
    date: DateType | number,
    amount: number,
  ): DateType;
  /**
   ...
   */
  declare function addDays<DateType extends Date>(
    date: DateType | number,
    amount: number,
  ): DateType;
  /**
   ...
   */
  declare function endOfMonth<DateType extends Date>(
    date: DateType | number,
  ): DateType;
  /**
   ...
   * //=> 1
   */
  declare function differenceInCalendarDays<DateType extends Date>(
    dateLeft: DateType | number,
    dateRight: DateType | number,
  ): number;
  /**
   ...
   */
  declare function startOfDay<DateType extends Date>(
    date: DateType | number,
  ): DateType;
  /**
   * @constant
  ...
  type index_DifferenceInCalendarWeeksOptions =
    DifferenceInCalendarWeeksOptions;
  ...
  type index_LocalizedOptions<LocaleFields extends keyof Locale> =
    LocalizedOptions<LocaleFields>;
  ...
  type index_SingleFieldCore<T extends FormInputInterface<any>> =
    SingleFieldCore<T>;
  ...
  declare namespace index {
    export {
      index_ArrayFieldCore as ArrayFieldCore,
      index_ButtonCore as ButtonCore,
      index_ButtonInListCore as ButtonInListCore,
      index_CheckboxCore as CheckboxCore,
      index_CheckboxGroupCore as CheckboxGroupCore,
      index_ContextMenuCore as ContextMenuCore,
      index_DialogCore as DialogCore,
      index_DismissableLayerCore as DismissableLayerCore,
      index_DropdownMenuCore as DropdownMenuCore,
      index_FocusScopeCore as FocusScopeCore,
      index_ImageCore as ImageCore,
      index_ImageInListCore as ImageInListCore,
      index_ImageStep as ImageStep,
      index_InputCore as InputCore,
      index_InputInListCore as InputInListCore,
      index_MenuCore as MenuCore,
      index_MenuItemCore as MenuItemCore,
      index_NodeCore as NodeCore,
      index_ObjectFieldCore as ObjectFieldCore,
      index_PopoverCore as PopoverCore,
      index_PresenceCore as PresenceCore,
      index_ProgressCore as ProgressCore,
      index_RovingFocusCore as RovingFocusCore,
      index_ScrollViewCore as ScrollViewCore,
      index_SelectCore as SelectCore,
      index_SelectInListCore as SelectInListCore,
      index_SingleFieldCore as SingleFieldCore,
      index_TabsCore as TabsCore,
      index_ToastCore as ToastCore,
      index_TreeCore as TreeCore,
      utils$1 as Utils,
      index_addDays as addDays,
      index_addWeeks as addWeeks,
      index_clamp as clamp,
      index_constructFrom as constructFrom,
      index_damping as damping,
      index_daysToMonthWeeks as daysToMonthWeeks,
      index_differenceInCalendarDays as differenceInCalendarDays,
      index_differenceInCalendarMonths as differenceInCalendarMonths,
      index_differenceInCalendarWeeks as differenceInCalendarWeeks,
      index_endOfISOWeek as endOfISOWeek,
      index_endOfMonth as endOfMonth,
      index_endOfWeek as endOfWeek,
      index_getAngleByPoints as getAngleByPoints,
      index_getDefaultOptions as getDefaultOptions,
      index_getISOWeek as getISOWeek,
      index_getISOWeekYear as getISOWeekYear,
      index_getMonthWeeks as getMonthWeeks,
      index_getPoint as getPoint,
      index_getTimezoneOffsetInMilliseconds as getTimezoneOffsetInMilliseconds,
      index_getWeek as getWeek,
      index_getWeekYear as getWeekYear,
      index_getWeeksInMonth as getWeeksInMonth,
      index_lastDayOfMonth as lastDayOfMonth,
      index_millisecondsInDay as millisecondsInDay,
      index_millisecondsInWeek as millisecondsInWeek,
      index_onCreateScrollView as onCreateScrollView,
      index_preventDefault as preventDefault,
      index_startOfDay as startOfDay,
      index_startOfISOWeek as startOfISOWeek,
      index_startOfISOWeekYear as startOfISOWeekYear,
      index_startOfMonth as startOfMonth,
      index_startOfWeek as startOfWeek,
      index_startOfWeekYear as startOfWeekYear,
      index_toDate as toDate,
    };
    export type {
      index_CalendarCore as CalendarCore,
      index_Day as Day,
      index_DefaultOptions as DefaultOptions,
      index_DialogProps as DialogProps,
      index_DifferenceInCalendarWeeksOptions as DifferenceInCalendarWeeksOptions,
      index_Direction as Direction,
      index_EndOfWeekOptions as EndOfWeekOptions,
      index_Era as Era,
      index_FirstWeekContainsDate as FirstWeekContainsDate,
      index_FormCore as FormCore,
      index_GetWeekOptions as GetWeekOptions,
      index_GetWeekYearOptions as GetWeekYearOptions,
      index_GetWeeksInMonthOptions as GetWeeksInMonthOptions,
      index_InputProps as InputProps,
      index_Locale as Locale,
      index_LocalizedOptions as LocalizedOptions,
      index_Month as Month,
      index_Orientation as Orientation,
      index_PointEvent as PointEvent,
      index_Quarter as Quarter,
      index_ScrollViewProps as ScrollViewProps,
      index_StartOfWeekOptions as StartOfWeekOptions,
      index_StartOfWeekYearOptions as StartOfWeekYearOptions,
    };
  }
   ...
   */
  type UnpackedRequestPayload<T> = NonNullable<
    T extends RequestPayload<infer U> ? (U extends null ? U : U) : T
  >;
  type RequestedResource<T extends (...args: any[]) => any> = UnpackedResult<
    Unpacked<ReturnType<T>>
  >;
  type TmpRequestResp<T extends (...args: any[]) => any> = Result<
    UnpackedRequestPayload<RequestedResource<T>>
  >;
  declare function onCreatePostPayload(
    h: (v: RequestPayload<any>) => void,
  ): void;
  declare function onCreateGetPayload(
    h: (v: RequestPayload<any>) => void,
  ): void;
  /**
  ...
  declare function request_factory(
    opt?: Partial<{
      hostnames: Partial<{
        dev: string;
        test: string;
  ...
  type utils_RequestedResource<T extends (...args: any[]) => any> =
    RequestedResource<T>;
  type utils_TmpRequestResp<T extends (...args: any[]) => any> =
    TmpRequestResp<T>;
  ...
  declare namespace utils {
    export {
      utils_onCreateGetPayload as onCreateGetPayload,
      utils_onCreatePostPayload as onCreatePostPayload,
      utils_request as request,
      utils_request_factory as request_factory,
    };
    export type {
      utils_RequestPayload as RequestPayload,
      utils_RequestedResource as RequestedResource,
      utils_TmpRequestResp as TmpRequestResp,
      utils_UnpackedRequestPayload as UnpackedRequestPayload,
    };
  }
  ...
  type TheResponseOfRequestCore<T extends RequestCore<any, any>> = NonNullable<
    T["response"]
  >;
  type TheResponseOfFetchFunction<T extends FetchFunction> =
  ...
  > extends BaseDomain<TheTypesOfEvents$2<any>> {
    _name: string;
    debug: boolean;
    ...
    onLoadingChange(
      handler: Handler<
        TheTypesOfEvents$2<UnpackedResult<P>>[Events$2.LoadingChange]
      >,
    ): () => void;
    beforeRequest(
      handler: Handler<
        TheTypesOfEvents$2<UnpackedResult<P>>[Events$2.BeforeRequest]
      >,
    ): () => void;
    onSuccess(
      handler: Handler<TheTypesOfEvents$2<UnpackedResult<P>>[Events$2.Success]>,
    ): () => void;
    onFailed(
      handler: Handler<TheTypesOfEvents$2<UnpackedResult<P>>[Events$2.Failed]>,
      opt?: Partial<{
        /** 清除其他 failed 监听 */
        override: boolean;
      }>,
    ...
    onCanceled(
      handler: Handler<
        TheTypesOfEvents$2<UnpackedResult<P>>[Events$2.Canceled]
      >,
    ): () => void;
    /** 建议使用 onFailed */
    onError(
    ...
    onCompleted(
      handler: Handler<
        TheTypesOfEvents$2<UnpackedResult<P>>[Events$2.Completed]
      >,
    ): () => void;
    onStateChange(
      handler: Handler<
        TheTypesOfEvents$2<UnpackedResult<P>>[Events$2.StateChange]
      >,
    ): () => void;
    onResponseChange(
      handler: Handler<
        TheTypesOfEvents$2<UnpackedResult<P>>[Events$2.ResponseChange]
      >,
    ): () => void;
  }
  ...
  > extends BaseDomain<TheTypesOfEvents$1<T>> {
    ...
    onStateChange(
      handler: Handler<TheTypesOfEvents$1<T>[Events$1.StateChange]>,
    ): () => void;
    onLoadingChange(
      handler: Handler<TheTypesOfEvents$1<T>[Events$1.LoadingChange]>,
    ): () => void;
    onBeforeSearch(
      handler: Handler<TheTypesOfEvents$1<T>[Events$1.BeforeSearch]>,
    ): () => void;
    onAfterSearch(
      handler: Handler<TheTypesOfEvents$1<T>[Events$1.AfterSearch]>,
    ): () => void;
    onDataSourceChange(
      handler: Handler<TheTypesOfEvents$1<T>[Events$1.DataSourceChange]>,
    ): () => void;
    onDataSourceAdded(
      handler: Handler<TheTypesOfEvents$1<T>[Events$1.DataSourceAdded]>,
    ): () => void;
    onError(
      handler: Handler<TheTypesOfEvents$1<T>[Events$1.Error]>,
    ): () => void;
    onComplete(
      handler: Handler<TheTypesOfEvents$1<T>[Events$1.Completed]>,
    ): () => void;
  }
  ...
  declare class MultipleSelectionCore<T> extends BaseDomain<
    TheTypesOfEvents<T>
  > {
  ...
  declare function createQRCode(
    text: string,
    options: CanvasDrawingProps,
  ): Promise<void>;
  ...
  declare function SlateEditorModel(props: {
    ...
    methods: {
      refresh(): void;
      emitSelectionChange(v: { type?: SlateOperationType }): void;
      ...
      collapse(): void;
      /** 移动光标 */
      move(opts: { unit: "line"; edge?: "focus"; reverse?: boolean }): void;
      getCaretPosition(): void;
      setCaretPosition(arg: { start: SlatePoint; end: SlatePoint }): void;
    ...
    ui: {
      $selection: {
        methods: {
          ...
          collapseToHead(): void;
          collapseToEnd(): void;
          collapseToOffset(param: { offset: number }): void;
          setToHead(): void;
          setStartAndEnd(param: { start: SlatePoint; end: SlatePoint }): void;
          handleChange(event: {
            start: SlatePoint;
            end: SlatePoint;
            collapsed: boolean;
  ...
  declare function findNodeByPathWithNode(
    nodes: SlateDescendant[],
    path: number[],
  ): SlateDescendant;
  ...
  declare function renderElement(
    node: SlateDescendant & {
      key?: number;
    },
    extra?: {
  ...
  declare function buildInnerHTML(
    nodes: SlateDescendant[],
    parents?: number[],
    level?: number,
  ): DocumentFragment;
  ...
  declare function renderNodeThenInsertLine(
    $input: Element,
    op: {
      node: SlateDescendant;
      path: number[];
  ...
  declare function renderLineNodesThenInsert(
    $input: Element,
    op: {
      node: SlateDescendant[];
      path: number[];
  ...
  declare function getNodePath(
    targetNode: Element,
    rootNode: Element,
  ): number[];
  declare function findNodeByPathWithElement(
    $elm: Element,
    path: number[],
  ): Element | null;
  declare function refreshSelection(
    $editor: Element,
    start: SlatePoint,
    end: SlatePoint,
  ): void;
  ...
  declare function ShortcutModel(
    props?: Partial<{
  ...
  export type {
    ...
    RouteAction,
    RouteConfig,
    TheResponseOfFetchFunction,
    TheResponseOfRequestCore,
    UnpackedResult,
  };
}
