...
import { wxResultify } from "@timeless/provider-weapp";
...
ImageCore.prefix = "https://media.funzm.com";
...
export const app = new Application({
  ...
  async beforeReady() {
    ...
    const r1 = await wxResultify<WechatMiniprogram.LoginSuccessCallbackResult>(
      wx.login
    )();
    if (r1.error) {
      app.tip({
