...
import { provide_ui_scroll_view_scroll, provide_ui_scroll_view_indicator } from "@timeless/provider-web";
...
export const Root = (props: { store: ScrollViewCore } & JSX.HTMLAttributes<HTMLDivElement>) => {
  ...
  onMount(() => {
    ...
    provide_ui_scroll_view_scroll(props.store, $elm);
  });
...
export const Indicator = (props: { store: ScrollViewCore } & JSX.HTMLAttributes<HTMLDivElement>) => {
  ...
  onMount(() => {
    ...
    provide_ui_scroll_view_indicator(props.store, $elm);
