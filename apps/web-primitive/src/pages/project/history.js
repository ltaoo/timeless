      ...
      View({ class: "space-y-1" }, [
        For({
          ...
          render(item) {
            return View(
              {
                class: "flex items-center gap-4 px-4 py-3 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors",
              },
              [
                View({
                  class: "w-2 h-2 rounded-full bg-zinc-300 dark:bg-zinc-600 shrink-0",
                }),
                View({ class: "flex-1 min-w-0" }, [
                  View(
                    {
                      class: "text-sm text-zinc-900 dark:text-zinc-100 truncate",
                    },
                    [item.action],
                  ),
                  View(
