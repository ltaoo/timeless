...
export function refresh_token() {
  return request.post<{ token: string; expires_at: number }>(
...
export function fetch_user_profile_process(
  r: TmpRequestResp<typeof fetch_user_profile>,
) {
  if (r.error) {
...
export function update_user_profile(
  body: Partial<{ nickname: string; avatar_url: string }>,
) {
