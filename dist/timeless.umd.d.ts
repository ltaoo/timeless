...
export declare const request: {
    ...
    }> | undefined): import("@/domains/request/utils").RequestPayload<T>;
...
import { BizError } from "@/domains/error";
import { TheResponseOfFetchFunction } from "@/domains/request/index";
...
type TheTypesOfEvents = {
    [Events.Tip]: string[];
    [Events.Error]: Error;
    [Events.Login]: UserState & {
        token: string;
        expires_at: number;
    };
    [Events.Logout]: void;
    [Events.Expired]: void;
    [Events.TokenRefresh]: UserState & {
        token: string;
        expires_at: number;
    };
...
export declare function UserModel(props: {
    id: string;
    username: string;
    avatar: string;
    token: string;
    ...
    methods: {
        refresh(): void;
        /** 校验用户凭证是否有效 */
        validate(): Promise<import("@/domains/result/index").Resp<null>>;
        /** 用户名密码登录 */
    ...
    ui: {
        $form: ObjectFieldCore<{
            email: SingleFieldCore<InputCore<string>>;
            password: SingleFieldCore<InputCore<string>>;
        }>;
    };
    state: {};
    ready(): void;
    ...
    onLogout(handler: Handler<void>): () => void;
    onExpired(handler: Handler<void>): () => void;
    onTokenRefresh(handler: Handler<{
        token: string;
        expires_at: number;
    }>): () => void;
    onStateChange(handler: Handler<{}>): () => void;
};
export declare class UserCore extends BaseDomain<TheTypesOfEvents> {
    name: string;
    debug: boolean;
    id: string;
    nickname: string;
    ...
    constructor(props: Partial<{
        _name: string;
    }> & UserProps, client: HttpClientCore);
    ...
    _refreshing: boolean;
    refreshToken(): Promise<void>;
    updateToken(data: TheResponseOfFetchFunction<typeof login>): void;
    setToken(v: string): void;
    onError(handler: Handler<TheTypesOfEvents[Events.Error]>): () => void;
    onLogin(handler: Handler<TheTypesOfEvents[Events.Login]>): () => void;
    onLogout(handler: Handler<TheTypesOfEvents[Events.Logout]>): () => void;
    onExpired(handler: Handler<TheTypesOfEvents[Events.Expired]>): () => void;
    onTokenRefresh(handler: Handler<TheTypesOfEvents[Events.TokenRefresh]>): () => void;
}
export {};


// From biz/user/services.d.ts
...
export declare function login(body: {
    email: string;
    password: string;
}): import("@/domains/request/utils").RequestPayload<{
    id: string;
    nickname: string;
    avatar_url: string;
    verified: string;
 ...
 * @returns
 */
export declare function register(body: {
    email: string;
    password: string;
}): import("@/domains/request/utils").RequestPayload<{
    id: string;
...
export declare function logout(body: {
    email: string;
    password: string;
}): import("@/domains/request/utils").RequestPayload<unknown>;
export declare function refresh_token(): import("@/domains/request/utils").RequestPayload<{
    token: string;
    expires_at: number;
}>;
export declare function get_token(): import("@/domains/request/utils").RequestPayload<unknown>;
/**
 * 获取当前登录用户信息详情
 * @returns
 */
export declare function fetch_user_profile(): import("@/domains/request/utils").RequestPayload<{
    id: number;
    uid: string;
    nickname: string;
    avatar_url: string;
...
export declare function fetch_user_profile_process(r: TmpRequestResp<typeof fetch_user_profile>): Result<{
    subscription: {
        name: string;
        status_text: any;
        expired_at_text: string | null;
        status: SubscriptionStatus;
        expired_at: string;
        count: number;
    };
...
export declare function validate(token: string): import("@/domains/request/utils").RequestPayload<{
    token: string;
}>;
export declare function update_user_profile(body: Partial<{
    nickname: string;
    avatar_url: string;
}>): import("@/domains/request/utils").RequestPayload<unknown>;
...
// From domains/app/connect.weapp.d.ts
...
}>(app: Application<T>): void;


// From domains/app/connect.web.d.ts
import { StorageCore } from "@/domains/storage/index";
...
export declare class Application<T extends {
    storage: StorageCore<any>;
...
// From domains/history/connect.web.d.ts
...
// From domains/http_client/connect.axios.d.ts
import { HttpClientCore } from "./index";
export declare function connect(store: HttpClientCore): void;


// From domains/http_client/connect.tauri.d.ts
import { HttpClientCore } from "./index";
export declare function connect(store: HttpClientCore): void;


// From domains/http_client/connect.wails3.d.ts
import { HttpClientCore } from "./index";
export declare function connect(store: HttpClientCore): void;


// From domains/http_client/connect.weapp.d.ts
import { HttpClientCore } from "./index";
export declare function connect(store: HttpClientCore): void;
...
export declare function RequestLoop(props: {
    ...
    start(...args: Parameters<(...args: unknown[]) => Promise<import("..").Result<any>>>): void;
    setFinish(): void;
    onError: (handler: Handler<BizError>) => void;
};
...
export declare class RouteViewCore extends BaseDomain<TheTypesOfEvents> {
    ...
    onSubViewsChange(handler: Handler<TheTypesOfEvents[Events.ViewsChange]>): () => void;
    onCurViewChange(handler: Handler<TheTypesOfEvents[Events.CurViewChange]>): () => void;
...
// From domains/ui/image/connect.web.d.ts
...
// From domains/ui/node/connect.web.d.ts
...
// From domains/ui/scroll-view/connect.web.d.ts
...
// From domains/video_player/connect.web.d.ts
...
// From domains/video_player/index.d.ts
/**
 * @file 播放器
 */
import { BaseDomain, Handler } from "@/domains/base";
