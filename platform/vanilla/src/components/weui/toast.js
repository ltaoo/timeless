...
const t = {
  ...
  body: ({ enter, exit }) => ({
    style: ["position:fixed;left:50%;top:50%;z-index:999;transform:translate(-50%,-50%);display:flex;flex-direction:column;align-items:center;gap:8px;padding:24px;min-width:120px;background:var(--weui-BG-4);border-radius:12px;color:#fff;", enter ? "animation:weui-fade-in .2s;" : "", exit ? "animation:weui-fade-out .2s;" : ""].join(""),
  }),
