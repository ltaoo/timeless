...
function ImageFilePreviewModel(props: ViewComponentProps) {
  const request = {
    video: {
...
export function ImageFilePreviewView(props: ViewComponentProps) {
  const [state, vm] = useViewModel(ImageFilePreviewModel, [props]);
  ...
  return (
    <div class="relative w-full h-full">
      ...
      <img class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" src={state().url} />
