...
export function Show(props: {
  ...
  const get_children_with_condition = (condition: boolean) => {
    ...
    when.subscribe({
      onChange(value) {
        ...
        if (!condition) {
          ...
          const target = get_children_with_condition(condition);
  ...
  get_children_with_condition(condition);
  ...
  return {
    ...
    hydrate(startDom: any, parentDom?: any) {
      ...
      const targetChildren = get_children_with_condition(condition);
