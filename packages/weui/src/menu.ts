...
const { Menu: HMenu, MenuItem: HItem, MenuLabel: HLabel, MenuSeparator: HSep, DropdownMenu: HDrop } = Headless;
...
export function Menu(p: Parameters<typeof HMenu>[0], c?: any) { return HMenu({ ...p, theme: t }, c); }
export function MenuItem(p: Parameters<typeof HItem>[0], c?: any) { return HItem({ ...p, theme: t }, c); }
export function MenuLabel(p: Parameters<typeof HLabel>[0], c?: any) { return HLabel({ ...p, theme: t }, c); }
export function MenuSeparator(p: Parameters<typeof HSep>[0]) { return HSep({ ...p, theme: t }); }
export function DropdownMenu(p: Parameters<typeof HDrop>[0], c?: any) { return HDrop({ ...p, theme: t }, c); }
