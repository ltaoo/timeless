...
import { h, InputPrimitive, Show, ViewProps } from "@timeless/headless";
...
export function Input(
  ...
  return InputPrimitive.Root(
    { store, class: cn(["t-input relative", props.class]) },
    [
      ...
      Show(
        {
          when: combine({ allowClear, hasValue, isLoading }, (t) => t.hasValue && t.allowClear && !t.isLoading),
        },
        [
          h(
