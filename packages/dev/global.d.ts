...
declare module "packages/headless/src/lazy-view" {
  import {
    ...
    ViewChildren,
    TimelessComponent,
  } from "packages/headless/src/view";
...
declare module "packages/ui/src/formv2/index" {
  ...
  export {
    ...
    SingleFieldCore,
    ArrayFieldCore,
  } from "packages/ui/src/formv2/field";
}
...
declare module "packages/ui/src/popper/index" {
  ...
  import type {
    ...
    Strategy,
    MiddlewareData,
  } from "packages/ui/src/popper/types";
...
declare module "packages/ui/src/toast/index" {
  ...
  export class ToastCore extends BaseDomain<TheTypesOfEvents> {
    ...
    onHide(handler: Handler<TheTypesOfEvents[Events.Hidden]>): () => void;
    onOpenChange(
      handler: Handler<TheTypesOfEvents[Events.OpenChange]>,
    ): () => void;
    onStateChange(
      handler: Handler<TheTypesOfEvents[Events.StateChange]>,
    ): () => void;
...
declare module "packages/kit/src/multiple/index" {
  ...
  export class MultipleSelectionCore<T> extends BaseDomain<
    TheTypesOfEvents<T>
  > {
...
declare module "packages/shadcn/src/scrollview" {
  ...
  export function ScrollView(
    ...
    children: ViewChildren,
  ): import("@timeless/headless").TimelessElement;
}
...
declare module "packages/shadcn/src/waterfall" {
  ...
  } from "packages/headless/src/index";
...
declare module "packages/shadcn/src/index" {
  ...
  import {
    CheckboxGroup,
    CheckboxGroupItem,
  } from "packages/shadcn/src/checkbox-group";
  ...
  import {
    ...
    AlertTitle,
    AlertDescription,
  } from "packages/shadcn/src/alert";
  ...
  import {
    ...
    TableHead,
    TableCell,
  } from "packages/shadcn/src/table";
  import { Field, Form } from "packages/shadcn/src/form";
  import {
    ResizablePanels,
    ResizablePanel,
    ResizableHandle,
  } from "packages/shadcn/src/resizable-panels";
