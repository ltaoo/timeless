...
export function Alert(p: any, c: any) { return H({ ...p, theme: t }, c); }
export function AlertTitle(p: any, c: any) { return HT({ ...p, theme: t }, c); }
export function AlertDescription(p: any, c: any) { return HD({ ...p, theme: t }, c); }
