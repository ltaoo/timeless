...
export function Popover(props: any, children?: any) {
  ...
  const visible = computed({ state }, (d: any) => d.state.visible || d.state.enter || d.state.exit);
        ...
        View({
          ...
          style: computed({ state }, (d: any) => {
            ...
            return [
              ...
              s.placement ? `transform:rotate(${
                s.placement.startsWith("top") ? 180 :
                s.placement.startsWith("right") ? -90 :
                s.placement.startsWith("bottom") ? 0 : 90
              }deg);` : "",
            ].join("");
          }),
        }),
